...
music = Node.create([
  ...
  {title: "I Sat By The Ocean", description: "Queen of the Stone Age", link: "https://soundcloud.com/qotsa/i-sat-by-the-ocean", kind: "music"},
...
sports = Node.create([ 
  ...
  {title: "Ultimate Best Football Tricks & Skills", description: "If you like my work, become a fan on facebook and follow me on twitter", link: "https://www.youtube.com/watch?v=j3BslT97fR4", kind: "video"},
  {title: "USA v AUS - Men's Basketball Quarterfinal | London 2012 Olympics", description: "The USA take on Australia in the quarterfinal of the men's basketball tournament at the London 2012 Olympic Games.", link: "https://www.youtube.com/watch?v=Aiem1w_TvaA", kind: "video"},
