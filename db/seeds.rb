...
# Music
music = Node.create([
  {title: "Tree of Life", description: "The Most Epic Music", link: "https://soundcloud.com/themostepicmusic/tree-of-life", kind: "music", tags: ''},
  {title: "I Sat By The Ocean", description: "Queen of the Stone Age", link: "https://soundcloud.com/qotsa/i-sat-by-the-ocean", kind: "music", tags: ''},
