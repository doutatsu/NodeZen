...
music = Node.create([
  ...
  {title:"Moderat - Bad Kingdom (DJ Koze Remix)",description:"A splendid track by Moderat remixed to perfection by DJ Koze.",link:"https://soundcloud.com/nanc-nanc/moderat-bad-kingdom-dj-koze-remix", preview:"",kind:"music", edges: moderat.join(','), edges: moderat.join(','), tags:"electronic, chill, moderat"},
])
